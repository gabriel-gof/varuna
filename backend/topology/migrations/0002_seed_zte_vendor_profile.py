...
def seed_zte_vendor_profile(apps, schema_editor):
    ...
    VendorProfile.objects.update_or_create(
        ...
        model_name="C300",
        defaults={
            "description": "ZTE C300 OID templates for ONU discovery, status, and power",
...
def remove_zte_vendor_profile(apps, schema_editor):
    VendorProfile = apps.get_model("topology", "VendorProfile")
    VendorProfile.objects.filter(vendor__iexact="zte", model_name__iexact="C300").delete()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(seed_zte_vendor_profile, remove_zte_vendor_profile),
    ]
