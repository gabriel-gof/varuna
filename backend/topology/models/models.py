...
class OLTSlot(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['olt', 'slot_id'], name='topology_o_olt_id_1fd7ed_idx'),
            models.Index(fields=['olt', 'slot_key'], name='topology_o_olt_id_4e23d0_idx'),
        ]
...
class OLTPON(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['olt', 'pon_id'], name='topology_o_olt_id_76b9d5_idx'),
            models.Index(fields=['slot', 'pon_id'], name='topology_o_slot_i_2cb314_idx'),
        ]
...
class ONU(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['olt', 'snmp_index'], name='topology_unique_olt_snmp_index'),
        ]
