...
from dashboard.models import OLT, ONU, ONULog, VendorProfile
...
class DiscoveryCommandTests(TestCase):
    ...
    @patch('dashboard.management.commands.discover_onus.snmp_service.walk')
...
class PollingCommandTests(TestCase):
    ...
    @patch('dashboard.management.commands.poll_onu_status.snmp_service.get')
