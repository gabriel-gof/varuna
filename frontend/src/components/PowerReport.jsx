                ...
                {visibleRows.map((row, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-0 align-middle text-[11px] truncate">{row.serial ? <span className="font-semibold font-mono tracking-tight text-slate-500 dark:text-slate-400">{row.serial}</span> : <span className={PLACEHOLDER_CLASS}>{MISSING_VALUE_PLACEHOLDER}</span>}</td>
